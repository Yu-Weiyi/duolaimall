 ...
 * @project duolaimall
 * @package pers.wayease.duolaimall.order.mq
 * @name DelayOrderConsumerStrategy
 * @description Delay order consumer strategy class.
 * @since 2024-10-21 03:47
 */
@Component
@Slf4j
public class DelayOrderConsumerStrategy implements ConsumeStrategy {
    ...
    public TopicConstant getTopicConstant() {
        return TopicConstant.DELAY_ORDER;
    }
...
//                Object messageObject = JSON.parseObject(jsonMessage, Object.class);
                ...
                Long orderId= Long.valueOf(jsonMessage);
