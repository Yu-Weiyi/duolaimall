 ...
 * @project duolaimall
 * @package pers.wayease.duolaimall.search.mq
 * @name SkuIncreaseHotScoreConsumeStrategy
 * @description SKU increase hot score consume strategy class.
 * @since 2024-10-17 14:20
 */
@Component
@Slf4j
public class SkuIncreaseHotScoreConsumeStrategy implements ConsumeStrategy {
    ...
    public TopicConstant getTopicConstant() {
        return TopicConstant.SKU_INCREASE_HOT_SCORE;
    }
